...
HD_PWD='C:/TDM_0704/TDM_0704/TDM_0704.runs/design_1_axis_capture_gate_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axis_capture_gate_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axis_capture_gate_0_0.tcl
