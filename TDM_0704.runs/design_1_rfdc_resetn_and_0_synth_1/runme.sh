...
HD_PWD='C:/TDM_0704/TDM_0704/TDM_0704.runs/design_1_rfdc_resetn_and_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rfdc_resetn_and_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rfdc_resetn_and_0.tcl
