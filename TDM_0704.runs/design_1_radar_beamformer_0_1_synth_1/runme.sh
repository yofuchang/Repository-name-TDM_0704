...
HD_PWD='C:/TDM_0704/TDM_0704/TDM_0704.runs/design_1_radar_beamformer_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_radar_beamformer_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_radar_beamformer_0_1.tcl
