...
set C_modelArgList {
	...
	{ dbg_lfm_i int 16 regular {pointer 1}  }
	{ dbg_lfm_q int 16 regular {pointer 1}  }
	{ dbg_tx_sel int 2 regular {pointer 1}  }
	{ dbg_chirp_count int 16 regular {pointer 1}  }
	{ dbg_sample_count int 16 regular {pointer 1}  }
	{ dbg_chirp_start int 1 regular {pointer 1}  }
	{ dbg_chirp_end int 1 regular {pointer 1}  }
	{ dbg_enable int 1 regular {pointer 1}  }
	{ dbg_state int 3 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ dbg_chirp_count sc_out sc_lv 16 signal 7 } 
	{ dbg_sample_count sc_out sc_lv 16 signal 8 } 
	{ dbg_chirp_start sc_out sc_lv 1 signal 9 } 
	{ dbg_chirp_end sc_out sc_lv 1 signal 10 } 
	{ dbg_enable sc_out sc_lv 1 signal 11 } 
	{ dbg_state sc_out sc_lv 3 signal 12 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			...
			{"Name" : "dbg_lfm_i", "Type" : "None", "Direction" : "O"},
			{"Name" : "dbg_lfm_q", "Type" : "None", "Direction" : "O"},
			{"Name" : "dbg_tx_sel", "Type" : "None", "Direction" : "O"},
			{"Name" : "dbg_chirp_count", "Type" : "None", "Direction" : "O"},
			{"Name" : "dbg_sample_count", "Type" : "None", "Direction" : "O"},
...
set Spec2ImplPortList { 
	...
	m_axis_tx_V_last_V { axis {  { m_axis_tx_TREADY out_acc 0 1 }  { m_axis_tx_TVALID out_vld 1 1 }  { m_axis_tx_TLAST out_data 1 1 } } }
	dbg_lfm_i { ap_none {  { dbg_lfm_i out_data 1 16 } } }
	dbg_lfm_q { ap_none {  { dbg_lfm_q out_data 1 16 } } }
	dbg_tx_sel { ap_none {  { dbg_tx_sel out_data 1 2 } } }
	dbg_chirp_count { ap_none {  { dbg_chirp_count out_data 1 16 } } }
	dbg_sample_count { ap_none {  { dbg_sample_count out_data 1 16 } } }
	dbg_chirp_start { ap_none {  { dbg_chirp_start out_data 1 1 } } }
	dbg_chirp_end { ap_none {  { dbg_chirp_end out_data 1 1 } } }
	dbg_enable { ap_none {  { dbg_enable out_data 1 1 } } }
	dbg_state { ap_none {  { dbg_state out_data 1 3 } } }
}
