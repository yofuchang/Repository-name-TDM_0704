; ModuleID = 'C:/TDM_0704/TDM_0704/iq_to_real/iq_to_real/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_iq_to_real_ir(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %s_axis_iq, %"class.hls::stream<ap_int<16>, 0>"* noalias nocapture nonnull dereferenceable(2) %m_axis_real) local_unnamed_addr #1 {
entry:
  %s_axis_iq_copy.data = alloca i32, align 512
  %s_axis_iq_copy.keep = alloca i4, align 512
  %s_axis_iq_copy.strb = alloca i4, align 512
  %s_axis_iq_copy.last = alloca i1, align 512
  %m_axis_real_copy = alloca i16, align 512
  call void @llvm.sideeffect() #7 [ "stream_interface"(i16* %m_axis_real_copy, i32 0) ]
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* nonnull %s_axis_iq, i32* nonnull align 512 %s_axis_iq_copy.data, i4* nonnull align 512 %s_axis_iq_copy.keep, i4* nonnull align 512 %s_axis_iq_copy.strb, i1* nonnull align 512 %s_axis_iq_copy.last, %"class.hls::stream<ap_int<16>, 0>"* nonnull %m_axis_real, i16* nonnull align 512 %m_axis_real_copy)
  call void @apatb_iq_to_real_hw(i32* %s_axis_iq_copy.data, i4* %s_axis_iq_copy.keep, i4* %s_axis_iq_copy.strb, i1* %s_axis_iq_copy.last, i16* %m_axis_real_copy)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %s_axis_iq, i32* %s_axis_iq_copy.data, i4* %s_axis_iq_copy.keep, i4* %s_axis_iq_copy.strb, i1* %s_axis_iq_copy.last, %"class.hls::stream<ap_int<16>, 0>"* %m_axis_real, i16* %m_axis_real_copy)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias "unpacked"="0", i32* noalias align 512 "unpacked"="1.0" %_V_data_V, i4* noalias align 512 "unpacked"="1.1" %_V_keep_V, i4* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_last_V, %"class.hls::stream<ap_int<16>, 0>"* noalias "unpacked"="2", i16* noalias nocapture align 512 "unpacked"="3.0") unnamed_addr #2 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.15"(i32* align 512 %_V_data_V, i4* align 512 %_V_keep_V, i4* align 512 %_V_strb_V, i1* align 512 %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_int<16>, 0>"(i16* align 512 %2, %"class.hls::stream<ap_int<16>, 0>"* %1)
  ret void
}
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias "unpacked"="0", i32* noalias align 512 "unpacked"="1.0" %_V_data_V, i4* noalias align 512 "unpacked"="1.1" %_V_keep_V, i4* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_last_V, %"class.hls::stream<ap_int<16>, 0>"* noalias "unpacked"="2", i16* noalias nocapture align 512 "unpacked"="3.0") unnamed_addr #5 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_int<16>, 0>.4"(%"class.hls::stream<ap_int<16>, 0>"* %1, i16* align 512 %2)
  ret void
}
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.15"(i32* noalias align 512 "unpacked"="0.0" %dst_V_data_V, i4* noalias align 512 "unpacked"="0.1" %dst_V_keep_V, i4* noalias align 512 "unpacked"="0.2" %dst_V_strb_V, i1* noalias align 512 "unpacked"="0.3" %dst_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias %src) unnamed_addr #3 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.18"(i32* align 512 %dst_V_data_V, i4* align 512 %dst_V_keep_V, i4* align 512 %dst_V_strb_V, i1* align 512 %dst_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.18"(i32* noalias nocapture align 512 "unpacked"="0.0" %_V_data_V, i4* noalias nocapture align 512 "unpacked"="0.1" %_V_keep_V, i4* noalias nocapture align 512 "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture align 512 "unpacked"="0.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nocapture) unnamed_addr #4 {
entry:
...
declare void @apatb_iq_to_real_hw(i32*, i4*, i4*, i1*, i16*)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias "unpacked"="0", i32* noalias align 512 "unpacked"="1.0" %_V_data_V, i4* noalias align 512 "unpacked"="1.1" %_V_keep_V, i4* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_last_V, %"class.hls::stream<ap_int<16>, 0>"* noalias "unpacked"="2", i16* noalias nocapture align 512 "unpacked"="3.0") unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %0, i32* align 512 %_V_data_V, i4* align 512 %_V_keep_V, i4* align 512 %_V_strb_V, i1* align 512 %_V_last_V)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_int<16>, 0>.4"(%"class.hls::stream<ap_int<16>, 0>"* %1, i16* align 512 %2)
  ret void
...
declare void @iq_to_real_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<ap_int<16>, 0>"* noalias nocapture nonnull)

define void @iq_to_real_hw_stub_wrapper(i32*, i4*, i4*, i1*, i16*) #6 {
entry:
  %5 = call i8* @malloc(i64 12)
  %6 = bitcast i8* %5 to %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"*
  %7 = call i8* @malloc(i64 2)
  %8 = bitcast i8* %7 to %"class.hls::stream<ap_int<16>, 0>"*
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %6, i32* %0, i4* %1, i4* %2, i1* %3, %"class.hls::stream<ap_int<16>, 0>"* %8, i16* %4)
  call void @iq_to_real_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %6, %"class.hls::stream<ap_int<16>, 0>"* %8)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %6, i32* %0, i4* %1, i4* %2, i1* %3, %"class.hls::stream<ap_int<16>, 0>"* %8, i16* %4)
  call void @free(i8* %5)
  call void @free(i8* %7)
  ret void
}
