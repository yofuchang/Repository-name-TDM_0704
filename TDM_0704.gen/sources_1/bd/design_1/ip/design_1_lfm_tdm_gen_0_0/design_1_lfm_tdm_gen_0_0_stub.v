...
//               c:/TDM_0704/TDM_0704/TDM_0704.gen/sources_1/bd/design_1/ip/design_1_lfm_tdm_gen_0_0/design_1_lfm_tdm_gen_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_lfm_tdm_gen_0_0,lfm_tdm_gen,{}" *) (* CORE_GENERATION_INFO = "design_1_lfm_tdm_gen_0_0,lfm_tdm_gen,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=lfm_tdm_gen,x_ipVersion=1.0,x_ipCoreRevision=2114696888,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CTRL_ADDR_WIDTH=4,C_S_AXI_CTRL_DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "lfm_tdm_gen,Vivado 2024.2" *) (* hls_module = "yes" *) 
module design_1_lfm_tdm_gen_0_0(dbg_lfm_i_ap_vld, dbg_lfm_q_ap_vld, 
  dbg_tx_sel_ap_vld, dbg_tx_active_ap_vld, dbg_chirp_count_ap_vld, 
  dbg_sample_count_ap_vld, dbg_chirp_start_ap_vld, dbg_chirp_end_ap_vld, 
  dbg_enable_ap_vld, dbg_state_ap_vld, s_axi_CTRL_ARADDR, s_axi_CTRL_ARREADY, 
  ...
  m_axis_tx_TVALID, dbg_lfm_i, dbg_lfm_q, dbg_tx_sel, dbg_tx_active, dbg_chirp_count, 
  dbg_sample_count, dbg_chirp_start, dbg_chirp_end, dbg_enable, dbg_state)
/* synthesis syn_black_box black_box_pad_pin="dbg_lfm_i_ap_vld,dbg_lfm_q_ap_vld,dbg_tx_sel_ap_vld,dbg_tx_active_ap_vld,dbg_chirp_count_ap_vld,dbg_sample_count_ap_vld,dbg_chirp_start_ap_vld,dbg_chirp_end_ap_vld,dbg_enable_ap_vld,dbg_state_ap_vld,s_axi_CTRL_ARADDR[3:0],s_axi_CTRL_ARREADY,s_axi_CTRL_ARVALID,s_axi_CTRL_AWADDR[3:0],s_axi_CTRL_AWREADY,s_axi_CTRL_AWVALID,s_axi_CTRL_BREADY,s_axi_CTRL_BRESP[1:0],s_axi_CTRL_BVALID,s_axi_CTRL_RDATA[31:0],s_axi_CTRL_RREADY,s_axi_CTRL_RRESP[1:0],s_axi_CTRL_RVALID,s_axi_CTRL_WDATA[31:0],s_axi_CTRL_WREADY,s_axi_CTRL_WSTRB[3:0],s_axi_CTRL_WVALID,ap_rst_n,interrupt,m_axis_tx_TDATA[31:0],m_axis_tx_TKEEP[3:0],m_axis_tx_TLAST[0:0],m_axis_tx_TREADY,m_axis_tx_TSTRB[3:0],m_axis_tx_TVALID,dbg_lfm_i[15:0],dbg_lfm_q[15:0],dbg_tx_sel[1:0],dbg_tx_active[3:0],dbg_chirp_count[15:0],dbg_sample_count[15:0],dbg_chirp_start[0:0],dbg_chirp_end[0:0],dbg_enable[0:0],dbg_state[2:0]" */
