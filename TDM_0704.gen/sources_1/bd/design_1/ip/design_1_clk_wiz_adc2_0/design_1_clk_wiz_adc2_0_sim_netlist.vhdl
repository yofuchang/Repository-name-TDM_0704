...
-- Date        : Mon Jul 20 19:27:00 2026
-- Host        : JohnsonKu running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/TDM_0704/TDM_0704/TDM_0704.gen/sources_1/bd/design_1/ip/design_1_clk_wiz_adc2_0/design_1_clk_wiz_adc2_0_sim_netlist.vhdl
-- Design      : design_1_clk_wiz_adc2_0
...
entity design_1_clk_wiz_adc2_0_clk_wiz is
  port (
    clk_out1 : out STD_LOGIC;
    locked : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end design_1_clk_wiz_adc2_0_clk_wiz;

architecture STRUCTURE of design_1_clk_wiz_adc2_0_clk_wiz is
  signal clk_in1_design_1_clk_wiz_adc2_0 : STD_LOGIC;
  signal clk_out1_design_1_clk_wiz_adc2_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_design_1_clk_wiz_adc2_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_design_1_clk_wiz_adc2_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      BANDWIDTH => "OPTIMIZED",
      CLKFBOUT_MULT_F => 76.000000,
      CLKFBOUT_PHASE => 0.000000,
      CLKFBOUT_USE_FINE_PS => "FALSE",
      CLKIN1_PERIOD => 64.000000,
      ...
      CLKIN1 => clk_in1_design_1_clk_wiz_adc2_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_design_1_clk_wiz_adc2_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_clk_wiz_adc2_0 is
  port (
    clk_out1 : out STD_LOGIC;
    locked : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  ...
  attribute NotValidForBitStream of design_1_clk_wiz_adc2_0 : entity is true;
end design_1_clk_wiz_adc2_0;

architecture STRUCTURE of design_1_clk_wiz_adc2_0 is
begin
inst: entity work.design_1_clk_wiz_adc2_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked
