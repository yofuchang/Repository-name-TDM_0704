...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_radar_beamformer_0_1_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_radar_beamformer_0_1,radar_beamformer,{}" *) (* CORE_GENERATION_INFO = "design_1_radar_beamformer_0_1,radar_beamformer,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=radar_beamformer,x_ipVersion=1.0,x_ipCoreRevision=2114687862,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CONTROL_ADDR_WIDTH=4,C_S_AXI_CONTROL_DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "radar_beamformer,Vivado 2024.2" *) (* hls_module = "yes" *) 
...
/* synthesis syn_force_seq_prim="ap_clk" */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 ap_clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME ap_clk, ASSOCIATED_BUSIF s_axi_control:in_data:out_data, ASSOCIATED_RESET ap_rst_n, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_0_pl_clk0, INSERT_VIP 0" *) input ap_clk /* synthesis syn_isclock = 1 */;
